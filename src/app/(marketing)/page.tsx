...
export default function Home() {
  return (
    <PageWrapper>
      <div className="flex flex-1 flex-col justify-center gap-1 bg-box bg-cover">
        <H1>
        ...
        <Paragraph>
          ...
          <a
            ...
            className="relative p-[5px] font-semibold underline decoration-gray-800 underline-offset-4 after:absolute after:inset-0 after:z-[-1] after:w-full after:rotate-[-5deg] after:rounded-[0.25rem] after:bg-main-200 after:shadow-md after:content-['']"
          >
            X state
          </a>{" "}
          in React.
